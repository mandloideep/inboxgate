...
The same isolated module file produced this exact `go mod graph` output:

```text
inboxgate.local/mcp-adr-evidence github.com/modelcontextprotocol/go-sdk@v1.7.0
inboxgate.local/mcp-adr-evidence go@1.26.0
inboxgate.local/mcp-adr-evidence go.yaml.in/yaml/v3@v3.0.5
inboxgate.local/mcp-adr-evidence golang.org/x/oauth2@v0.36.0
inboxgate.local/mcp-adr-evidence toolchain@go1.26.6
inboxgate.local/mcp-adr-evidence turso.tech/database/tursogo-serverless@v0.0.0-20260817122138-24adc316cdc4
